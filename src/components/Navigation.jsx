...
const S = {
  ...
  desktopLink: (active) => ({
    ...
    color: active ? "#00c882" : "#64748b",
    background: active ? "rgba(0,200,130,0.08)" : "transparent",
    border: active ? "1px solid rgba(0,200,130,0.2)" : "1px solid transparent",
    textDecoration: "none",
  ...
  drawer: {
    ...
    padding: "0.85rem clamp(0.85rem,4vw,1.5rem) 1.25rem",
  },
  drawerLink: (active) => ({
    ...
    color: active ? "#00c882" : "#94a3b8",
    background: active ? "rgba(0,200,130,0.07)" : "rgba(255,255,255,0.02)",
    border: `1px solid ${active ? "rgba(0,200,130,0.2)" : "rgba(255,255,255,0.05)"}`,
    minHeight: 48,
  }),
  drawerInstall: {
      ...
      <nav style={S.nav(scrolled)}>
        ...
        <div style={{ marginLeft: isMobile ? "auto" : 0, display: "flex", alignItems: "center", gap: 8 }}>
          <motion.a
            ...
            whileHover={{ scale: 1.04, boxShadow: "0 0 22px rgba(0,200,130,0.5)" }}
            whileTap={{ scale: 0.96 }}
            style={S.installBtn}
          >
                ...
                return (
                  ...
                  >
                    <Link to={to} style={S.drawerLink(active)}>
                      ...
                      {label}
                      {active && (
                        <span style={{ marginLeft: "auto", width: 6, height: 6, background: "#00c882", borderRadius: "50%", boxShadow: "0 0 6px #00c882" }} />
                      )}
                    </Link>
                  </motion.div>
                );
